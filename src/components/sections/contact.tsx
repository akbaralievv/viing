          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  <span className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors">
                    <Phone aria-hidden="true" />
                  </span>
                  <span>
                    <span className="block text-sm text-muted-foreground">{t("phoneLabel")}</span>
              ...
              <li>
                ...
                >
                  ...
                  <span>
                    <span className="block text-sm text-muted-foreground">{t("emailLabel")}</span>
                    <span className="font-semibold group-hover:text-primary transition-colors">
              ...
              <li>
                <div className="flex items-start gap-4">
                  ...
                  <span>
                    <span className="block text-sm text-muted-foreground">{t("addressLabel")}</span>
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              <a
                ...
                className="flex items-center gap-2 px-5 h-12 rounded-xl bg-[#229ED9] text-white font-medium hover:opacity-90 transition-opacity"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-5 h-12 rounded-xl bg-[#25D366] text-white font-medium hover:opacity-90 transition-opacity"
              >
            ...
            <div className="mt-8 p-6 bg-muted/50 rounded-2xl">
              <h3 className="font-semibold mb-3">{t("hoursTitle")}</h3>
...
export { TelegramIcon, WhatsappIcon };
